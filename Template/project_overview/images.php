                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <?php if($file['id'] != $coverimage['id']){ ?>
                                        <?= $this->url->link(t('set as coverimage'), 'ProjectCoverimageController', 'set', array('plugin' => 'coverimage', 'task_id' => $task['id'], 'project_id' => $project['id'], 'file_id' => $file['id'])) ?>
                                    <?php } else { ?>
                                        <?= $this->url->link(t('remove coverimage'), 'ProjectCoverimageController', 'remove', array('plugin' => 'coverimage', 'task_id' => $task['id'], 'project_id' => $project['id'], 'file_id' => $file['id'])) ?>
                                    <?php } ?>
                                </li>
                            </ul>
                        </div>
